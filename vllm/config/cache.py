...
class CacheConfig:
    ...
    Set automatically by `_align_hybrid_block_size` (via
    `check_and_update_config`); defaults to 1 for non-hybrid models.
    Related: `MambaSpec.large_block_factor` (the spec-layer copy)."""
